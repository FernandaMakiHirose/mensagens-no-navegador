...
3. Crie uma pasta no C: -> Dentro da pasta crie uma pasta ‘index.php’ 
4. Vá na pasta: xamp-control.exe 
5. No xampp no ‘apache’ clique em ‘config’ - ‘apache (httpd.conf)’ - procure por ‘documentroot’ <br>
